...
export class DomaineComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dateSelectionner(this.currentDate, this.societe);
  ...
  dateSelectionner(annee, societe){
    this.otherService.statDomaineByYear(annee, societe).subscribe(
      data => {
        this.dataYear = data;
  ...
  exportCsv(annee, societe): void {
    ...
    this.otherService.statDomaineByYear(annee, societe).subscribe((data: any) => {
      this.dataInter =  data.data;
        this.extractionService.exportToCsv(
          this.dataInter, 
          'ExtractionStatDomaine' + '-' + this.date.getFullYear() + '-' + this.date.getMonth() + '-' + this.date.getDay() + '-' + this.date.getHours()+ '-' + this.date.getMinutes(),
          ['domaine', 'homme', 'femme' ]
        );
    })
  }
